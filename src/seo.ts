...
export const pages: Record<string, { title: string; description: string; label: string }> = {
  ...
  '/contratos/': { title: 'Redacción y Revisión de Contratos en Cidra | Raquel Núñez', description: 'Contratos de construcción, remodelación, arrendamiento y compraventa en Cidra. Redacción y revisión para la zona central. Coordine su consulta.', label: 'Contratos' },
