...
export const pages: Record<string, { title: string; description: string; label: string }> = {
  ...
  '/contratos/': { title: 'Contratos en Cidra | Raquel Núñez', description: 'Redacción y revisión de contratos civiles y comerciales en Cidra. Orientación para la zona central de Puerto Rico. Llame para coordinar su cita.', label: 'Contratos' },
